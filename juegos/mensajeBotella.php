...
<head>
    ...
    <title>Mensaje en Botella</title>
    ...
    <style>
        body {
            background-image: url('https://static.nationalgeographicla.com/files/styles/image_3200/public/01-waterbottlesun_20190719_0023.jpg?w=1900&h=1267');
        ...
        .card {
            ...
            padding: 20px;
            border: 3px solid #ff5fd0;
            border-radius: 10px;
            box-shadow: 0 0 20px rgba(255, 0, 215, 0.5);
            width: 90%;
            max-width: 500px;
            animation: glow 2s infinite alternate;
        }
        @keyframes glow {
            from { box-shadow: 0 0 20px rgba(255, 0, 215, 0.5); }
            to { box-shadow: 0 0 30px rgba(255, 0, 215, 0.5); }
        }
        .card h1 {
            color: #ff5fd0;
            font-size: 1.5rem;
        ...
        .preview-container img {
            ...
            height: auto;
            margin: 10px 0;
            border: 2px solid ##ff5fd0;
            border-radius: 10px;
            box-shadow: 0 0 10px #ff5fd0;
        ...
        .custom-file-upload, #submitBtn {
            ...
            border-radius: 5px;
            cursor: pointer;
            box-shadow: 0 0 10px rgba(255, 0, 215, 0.5);
            transition: all 0.3s;
            font-family: 'Press Start 2P', cursive;
            font-size: 0.7rem;
            display: inline;
...
<body>
    <div class="card">
        <h1>Reto: Mensaje emotivo dentro de una botella 🍾</h1>
